 ...
 */
export class Client {
    public readonly geolocate: geolocate.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.geolocate = new geolocate.ServiceClient(base)
    }
 ...
 */
import { analyze as api_geolocate_analyze_analyze } from "~backend/geolocate/analyze";
import {
    getHistory as api_geolocate_history_getHistory,
    saveAnalysis as api_geolocate_history_saveAnalysis
} from "~backend/geolocate/history";
import { getStats as api_geolocate_stats_getStats } from "~backend/geolocate/stats";

export namespace geolocate {
    ...
    export class ServiceClient {
         ...
         */
        public async analyze(params: RequestType<typeof api_geolocate_analyze_analyze>): Promise<ResponseType<typeof api_geolocate_analyze_analyze>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analyze`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_geolocate_analyze_analyze>
        }

        /**
         * Retrieves the analysis history with pagination.
         */
        public async getHistory(params: RequestType<typeof api_geolocate_history_getHistory>): Promise<ResponseType<typeof api_geolocate_history_getHistory>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_geolocate_history_getHistory>
        }

        /**
         * Retrieves analytics and statistics about geolocation analyses.
         */
        public async getStats(): Promise<ResponseType<typeof api_geolocate_stats_getStats>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/stats`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_geolocate_stats_getStats>
        }

        /**
         * Saves an analysis to the history.
         */
        public async saveAnalysis(params: RequestType<typeof api_geolocate_history_saveAnalysis>): Promise<ResponseType<typeof api_geolocate_history_saveAnalysis>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/history`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_geolocate_history_saveAnalysis>
        }
    }
}
