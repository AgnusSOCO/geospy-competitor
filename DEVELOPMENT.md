...
```bash
git remote add encore encore://geospy-competitor-6qki
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/geospy-competitor-6qki/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/geospy-competitor-6qki/settings/integrations/github)
